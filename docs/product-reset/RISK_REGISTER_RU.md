...
| R09 | UX оценят по build, без фактического интерфейса | Частично снижен: Commit 3.2 прошёл в реальном Chromium на `1366` и `1920`; полный rubric evidence впереди | Playwright на двух viewport; CP2 result не был объявлен зелёным | screenshots, axe, before/after и rubric score в CP7 |
...
Commit 3.2 фиксирует local-authoritative single-flight autosave, draft recovery, final scenario UI и полное удаление CP2 bridge. Component, build, backend и real-browser gates проходят; independent review принят. CP3 ещё не закрыт: нужны history/diff/restore, always-latest CaptionPanels и runner-owned CP3 evidence в Commits 3.3–3.5.
