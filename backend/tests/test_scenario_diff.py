...
def test_inserting_a_row_does_not_report_unchanged_rows_as_moved() -> None:
    ...
    assert summary == {"added": 1, "removed": 0, "changed": 0, "moved": 0, "settings_changed": 0, "total": 1}
...
def test_relative_reorder_reports_only_the_minimum_moved_rows() -> None:
    ...
    assert summary == {"added": 0, "removed": 0, "changed": 0, "moved": 1, "settings_changed": 0, "total": 1}
